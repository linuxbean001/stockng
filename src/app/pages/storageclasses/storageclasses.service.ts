...
import { Table, SearchResult } from './storageclasses.model';

import { tableData } from './data';

import { SortDirection } from './storageclasses-sortable.directive';
...
function matches(tables: Table, term: string, pipe: PipeTransform) {
    return tables.name.toLowerCase().includes(term)
        || tables.provisioner.toLowerCase().includes(term)
        || tables.parameters.toLowerCase().includes(term)
