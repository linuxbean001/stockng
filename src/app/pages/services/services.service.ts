...
import { Table, SearchResult } from './services.model';

import { tableData } from './data';

import { SortDirection } from './services-sortable.directive';
...
function matches(tables: Table, term: string, pipe: PipeTransform) {
    return tables.name.toLowerCase().includes(term)
        ...
        || tables.clusterip.toLowerCase().includes(term)
        || tables.internalendpoints.toLowerCase().includes(term)
        || tables.externalendpoints.toLowerCase().includes(term)
