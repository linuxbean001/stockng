...
import { Table, SearchResult } from './budashboard.model';

import { tableData } from './tabledata';

import { SortDirection } from './budashboard-sortable.directive';
...
function matches(tables: Table, term: string, pipe: PipeTransform) {
    return tables.pod.toLowerCase().includes(term)
...
export class BudashboardService {
