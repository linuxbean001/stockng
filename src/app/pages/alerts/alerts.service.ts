...
import { Table, SearchResult } from './alerts.model';

import { tableData } from './data';

import { SortDirection } from './alerts-sortable.directive';
...
function matches(tables: Table, term: string, pipe: PipeTransform) {
    return tables.alert.toLowerCase().includes(term)
        || tables.organization.toLowerCase().includes(term)
        || tables.level.toLowerCase().includes(term)
