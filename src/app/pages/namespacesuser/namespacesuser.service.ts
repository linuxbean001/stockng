...
import { Table, SearchResult } from './namespacesuser.model';

import { tableData } from './data';

import { SortDirection } from './namespacesuser-sortable.directive';
...
function matches(tables: Table, term: string, pipe: PipeTransform) {
    return tables.usergroup.toLowerCase().includes(term)
        || tables.addeddate.toLowerCase().includes(term)
...
export class NamespacesuserService {
